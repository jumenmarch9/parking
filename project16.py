...
def index():
    ...
    <html>
    <head>
        <title>Smart Parking System - Korean Priority</title>
        <style>
            ...
            .korean-priority { background-color: #d4edda; border: 1px solid #c3e6cb; color: #155724; }
        </style>
    </head>
    <body>
        <div class="container">
            <h1>스마트 주차 관리 시스템 (한국어 우선 인식)</h1>
            
            <div class="korean-priority">
                <h4>한국어 우선 인식 모드</h4>
