...
def generate_frames():
    ...
    print("Picamera2 + EasyOCR video stream started")
...
def index():
    ...
    <html>
    <head>
        <title>Smart Parking System - EasyOCR Korean Priority</title>
        <style>
            ...
            .easyocr-mode {{ background-color: #e3f2fd; border: 1px solid #bbdefb; color: #0d47a1; }}
        </style>
    </head>
    <body>
        <div class="container">
            <h1>스마트 주차 관리 시스템 (EasyOCR + 한국어 우선)</h1>
            
            <div class="easyocr-mode">
                <h4>EasyOCR + 한국어 우선 인식 모드</h4>
                ...
                <p>3단계: 최후 수단으로 가장 긴 텍스트 선택</p>
                <p>신뢰도 임계값: 0.7 (YOLOv5), 0.5 (EasyOCR)</p>
            </div>
            
            <div class="video-container">
                <img src="{{{{ url_for('video_feed') }}}}" width="640" height="480" alt="Picamera2 + EasyOCR Feed">
            </div>
...
if __name__ == '__main__':
    try:
        print("스마트 주차 시스템 시작 (EasyOCR + 한국어 우선)!")
