...
def generate_frames():
    ...
    print("Webcam + EasyOCR video stream started")
...
def index():
    ...
    <html>
    <head>
        <title>Smart Parking System - Webcam EasyOCR Korean Priority</title>
        <style>
    ...
    <body>
        <div class="container">
            <h1>스마트 주차 관리 시스템 (웹캠 + EasyOCR + 한국어 우선)</h1>
            
            <div class="easyocr-mode">
                <h4>웹캠 + EasyOCR + 한국어 우선 인식 모드</h4>
                <p>카메라: USB 웹캠</p>
            ...
            <div class="video-container">
                <img src="{{{{ url_for('video_feed') }}}}" width="640" height="480" alt="Webcam + EasyOCR Feed">
            </div>
...
if __name__ == '__main__':
    try:
        print("스마트 주차 시스템 시작 (웹캠 + EasyOCR + 한국어 우선)!")
        print("카메라: USB 웹캠")
